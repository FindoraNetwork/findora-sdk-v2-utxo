...
var getTransferOperation = function (walletInfo, utxoInputs, recieversInfo, assetCode, transferOp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ledger = _b.sent();
                return [4 /*yield*/, fee.getAssetDetails(assetCode)];
            case 2:
                asset = _b.sent();
...
var buildTransferOperationWithFee = function (walletInfo, assetBlindRules) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('c1');
                return [4 /*yield*/, findora_sdk_v2_core_1.feeService.getMinimalFee()];
            case 1:
                minimalFee = _a.sent();
                console.log('c2');
                return [4 /*yield*/, findora_sdk_v2_core_1.feeService.getFraAssetCode()];
            case 2:
                fraAssetCode = _a.sent();
                console.log('c3');
                return [4 /*yield*/, findora_sdk_v2_core_1.feeService.getFraPublicKey()];
            case 3:
                toPublickey = _a.sent();
                recieversInfo = [
                    {
...
var getFeeInputs = function (walletInfo, excludeSids, isBarToAbar) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ledger = _b.sent();
                return [4 /*yield*/, findora_sdk_v2_network_1.Network.getOwnedSids(walletInfo.publickey)];
            case 2:
                sidsResult = _b.sent();
                ...
                return [4 /*yield*/, findora_sdk_v2_core_1.feeService.getBarToAbarMinimalFee()];
            case 3:
                _a = _b.sent();
                return [3 /*break*/, 6];
            case 4: return [4 /*yield*/, findora_sdk_v2_core_1.feeService.getMinimalFee()];
            case 5:
                _a = _b.sent();
                _b.label = 6;
            case 6:
...
var buildTransferOperation = function (walletInfo, recieversInfo, assetCode) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('d1');
                console.log('n env', findora_sdk_v2_network_1.NetworkEnvironment);
                return [4 /*yield*/, findora_sdk_v2_network_1.Network.getOwnedSids(walletInfo.publickey)];
            case 1:
                sidsResult = _a.sent();
                console.log('d2');
